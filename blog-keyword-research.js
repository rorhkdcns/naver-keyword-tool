...
const SEED_KEYWORDS = [
  ...
  '스트레스해소', '바디케어', '스킨케어', '보습', '수면케어', '릴렉스',
];
// ⚠️ 너무 길고 구체적인 합성어(예: "여성셀프케어템")는 네이버가 연관키워드를
//    거의 확장해주지 않고 그 단어 자체만 돌려준다 (검색량도 다 "10 미만"으로 나옴).
//    반드시 위처럼 짧고 일반적인 뿌리 단어를 써야 관련 검색어가 넓게 확장됨.
...
const THEME_ANCHORS = [
  '셀프케어', '자기관리', '건강관리', '컨디션관리', '웰빙', '웰니스', '힐링',
  '스트레스해소', '바디케어', '스킨케어', '보습', '수면', '릴렉스', '릴랙스',
];
